...
func (r *CommentRepository) Create(ctx context.Context, comment *models.Comment) error {
	query := `
		INSERT INTO comments (post_id, title, content, author_id, author_name, image_url, reply_to_comment_id, created_at)
		VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
		RETURNING id`
	
	err := r.db.QueryRowContext(ctx, query,
		comment.PostID, comment.Title, comment.Content, comment.AuthorID,
		comment.AuthorName, comment.ImageURL, comment.ReplyToCommentID, comment.CreatedAt,
	).Scan(&comment.ID)
